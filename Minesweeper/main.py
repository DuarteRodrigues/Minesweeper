...
class MyButton(tk.Button):
    def __init__(self, master, x, y, number=0, *args, **kwargs):
        super(MyButton, self).__init__(
                master, *args, **kwargs, width=3, font='Calibri 20 bold')
        self.x = x
        self.y = y
        self.number = number
        self.is_mine = False
...
class MineSweeper:
    ...
    IS_GAME_OVER = False
    IS_FIRST_CLICK = True
    window.title('Minesweeper IPLuso')
    window.geometry('+800+200')

    flag_img = ImageTk.PhotoImage(Image.open("Minesweeper/flag.png"))
    mine_img = ImageTk.PhotoImage(Image.open("Minesweeper/mine.png"))
